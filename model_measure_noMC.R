...
U_Wuhle_ALT<-matrix(c(0, 0, 0, 0, 0, 0, 0, 0/2), nrow = 2, ncol = 4, dimnames = names_U)
U_Wuhle_EFH<-matrix(c(0, 0, 0, 0, 0, 0, 0, 0/2), nrow = 2, ncol = 4, dimnames = names_U)
U_Wuhle_GEW<-matrix(c(0, 0, 0, 0, 0, 0, 0, 0/2), nrow = 2, ncol = 4, dimnames = names_U)
U_Wuhle_NEU<-matrix(c(0, mr, 0, 0, 0, mr, 0, mr/2), nrow = 2, ncol = 4, dimnames = names_U)
U_Wuhle_AND<-matrix(c(0, 0, 0, 0, 0, 0, 0, 0/2), nrow = 2, ncol = 4, dimnames = names_U)


# MAßnahmenumfang Flughafensee; vielleicht noch in Liste verstauen
U_Flughafensee_ALT<-matrix(c(0, mr, 0, 0, 0, mr, 0, mr/2), nrow = 2, ncol = 4, dimnames = names_U)
U_Flughafensee_EFH<-matrix(c(0, 0, 0, 0, 0, 0, 0, 0/2), nrow = 2, ncol = 4, dimnames = names_U)
U_Flughafensee_GEW<-matrix(c(0, 0, 0, 0, 0, 0, 0, 0/2), nrow = 2, ncol = 4, dimnames = names_U)
U_Flughafensee_NEU<-matrix(c(0, 0, 0, 0, 0, 0, 0, 0/2), nrow = 2, ncol = 4, dimnames = names_U)
U_Flughafensee_AND<-matrix(c(0, 0, 0, 0, 0, 0, 0, 0/2), nrow = 2, ncol = 4, dimnames = names_U)
    ...
    for (OgRe_type in OgRe_types) {
      ...
      for (substance in substances) {
        ...
        for (my_source in sources) {
          ...
          source_loads[index_substance, index_source] <- c_anchor*sum(BTFs_current[row_runoff, col_runoff])
...
#for(catchment in catchments){
 ...
 # write.csv(MC_loads, paste0('data_output/Frachtreduktion/loads_',catchment,'_measure_extend_',mr*100,'%.csv'),row.names = FALSE)
