...
Diuron_load_filtered <- substance_load
Mecoprop_load_filtered <- substance_load
Terbutryn_load_filtered <- substance_load
Benzothiazol_load_filtered <- substance_load
...
for (n in 1:nMC){
  ...
  for (substance in substances) {
    ...
    if(substance== 'Diuron'){
      Diuron_load_filtered[n,]<-current_load - filter_capacity*current_load*filter_efficiencies[index_substance]
    }else if(substance== 'Mecoprop'){
      Mecoprop_load_filtered[n,]<-current_load - filter_capacity*current_load*filter_efficiencies[index_substance]
    }else if(substance== 'Terbutryn'){
      Terbutryn_load_filtered[n,]<-current_load - filter_capacity*current_load*filter_efficiencies[index_substance]
    }else if(substance== 'Benzothiazol'){
      Benzothiazol_load_filtered[n,]<-current_load - filter_capacity*current_load*filter_efficiencies[index_substance]
    }else if(substance== 'Zn'){
      Zn_load_filtered[n,]<-current_load - filter_capacity*current_load*filter_efficiencies[index_substance]
    }else if(substance== 'Cu'){
      Cu_load_filtered[n,]<-current_load - filter_capacity*current_load*filter_efficiencies[index_substance]
    }
