...
boxplot(DataValue~VariableName, data = x_Panke, log = "y", las=1, col = 'lightblue', xlab='', ylab = 'µg/L', cex.lab=1.2, cex.axis=1.2, names= c('Diuron', 'Mecoprop', 'Zink'), ylim= c(1e-02,1e+03))
