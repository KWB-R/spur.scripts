...
x_in <- foreign::read.dbf(file.path(data.dir, 'abimo_2019_mitstrassen.dbf'), as.is = TRUE)
...
write.dbf.abimo(df_name = x_in_roofs, new_dbf = file.path(write.dir, 'vs_2019_roofs.dbf'))
...
#write ABIMO input file
write.dbf.abimo(df_name = x_in_streets, new_dbf = file.path(write.dir, 'vs_2019_streets.dbf'))
...
#write ABIMO input file
write.dbf.abimo(df_name = x_in_yards, new_dbf = file.path(write.dir, 'vs_2019_yards.dbf'))
